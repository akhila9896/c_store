            ...
            <div class="col-md-6">
                ...
                <form method="post" action="/buynowaction">
                    ...
                    <div class="form-group">
                        ...
                        <select required type="text" class="form-control" name="paymentmethod" id="paymentmethod">
                ...
                <div class="order_review">
                            ...
                            <table id="example1" class="table  table-borderless table-striped "
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td tabindex="0"><img src="/uploads/{{$value->productimage}}" alt="Image"
                    ...
                    <div class="amount" style=" text-align: right; ">
                        <button class="btn btn-gray">
                            ...
                            <input type="hidden" name="totalamount" value="{{$value->psum}}">
                        </button>
                    </div><br><br>
                    @endforeach
